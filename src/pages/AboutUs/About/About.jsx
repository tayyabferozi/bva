...
const About = () => {
  return (
    <div className="about-us-main">
      <h1 className="mb-10">About BVA</h1>
      ...
      <p className="mt-20">
        ...
        household effects, company closures and more. We also auction real
        estate, cars, art and antiques. We bring supply and demand together on
        our auction platform. Will you also be giving these lots a second life?
        Start bidding now!
      </p>
    </div>
  );
